---
title: "3.1.2 — Proprioceptive Sensors"
sidebar_label: "3.1.2 — Proprioceptive Sensors"
sidebar_position: 2
...
# 3.1.2 — Proprioceptive Sensors

<DifficultyBadge level="intermediate" />

> **Summary**: Learn internal sensing for robots — encoders for joint positions, IMUs for orientation, and force/torque sensors for contact forces.
...
## 🎯 Part 2: Inertial Measurement Units (IMUs)
...
class IMU:
    ...
    def update(self, accel: np.ndarray, gyro: np.ndarray):
        ...
        Args:
            ...
            gyro: Gyroscope reading [ωx, ωy, ωz] (rad/s)
        """
...
## 🎯 Part 3: Force/Torque Sensors

### Sensor Types

**Strain Gauge-Based:**
- Wheatstone bridge circuit
- Measures deformation → force
...
### 🎯 Exercise: Complete State Estimator
...
**Success Criteria**:
- ✅ Accurate joint positions (< 0.1° error)
- ✅ Stable orientation estimate (no drift)
...
**[3.1.3 — Actuator Technologies →](./03-actuator-technologies)**
