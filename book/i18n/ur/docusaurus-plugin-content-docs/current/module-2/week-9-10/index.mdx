---
title: "2.2 — Locomotion & Gait Control"
...
- [2.1 — Kinematics & Dynamics](../week-6-8/) — FK, IK, dynamics fundamentals
...
1. **[2.2.1 — Gait Generation](./01-gait-generation)** (3-4 hours)  
   Walking patterns, CPGs, trajectory optimization, and gait parameters

2. **[2.2.2 — Balance Control](./02-balance-control)** (3-4 hours)  
   ZMP-based controllers, push recovery, and dynamic stability

3. **[2.2.3 — Terrain Adaptation](./03-terrain-adaptation)** (2-3 hours)  
...
- ✅ Use hands while moving
- ✅ See over obstacles
- ❌ Complex balance control required
- ❌ Higher energy consumption than wheels
...
- ZMP outside → Falling (rotation about foot edge)
...
## 💻 Preview: Simple Walking Controller
...
**[2.2.1 — Gait Generation →](./01-gait-generation)**
