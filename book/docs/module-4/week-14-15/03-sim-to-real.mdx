---
title: "4.1.3 — Sim-to-Real Transfer"
sidebar_label: "4.1.3 — Sim-to-Real"
sidebar_position: 3
...
> **Summary**: Bridge the reality gap — train policies in simulation and deploy them successfully on real hardware.
...
## 🎯 Part 1: Domain Randomization

### Core Idea

**Train on diverse simulations → Policy learns invariant features → Robust to reality**
...
### 🎯 Exercise: Sim-to-Real for Manipulation
...
**Success Criteria:**
- ✅ Policy trained in < 500K steps
- ✅ System ID error < 10%
- ✅ Real robot success rate > 80%
- ✅ No safety violations during deployment
...
**[4.1.4 — Real-World Applications →](/docs/module-4/week-14-15/applications)**
