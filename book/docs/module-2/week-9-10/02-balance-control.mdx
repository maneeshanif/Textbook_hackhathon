---
title: "2.2.2 — Balance Control and Push Recovery"
...
- [2.2.1 — Gait Generation](/docs/module-2/week-9-10/gait-generation) — Understanding of gait cycles
- [2.1.4 — Balance and ZMP](/docs/module-2/week-6-8/balance-zmp) — ZMP stability criterion
...
graph TD
    ...
    B -->|Small<br/>≈10N| C[Ankle Strategy]
    B -->|Medium<br/>≈50N| D[Hip Strategy]
    B -->|Large<br/>≈100N+| E[Stepping Strategy]
...
**Advantage over Ankle**: 3-5× faster CoM movement
...
Continue to [2.2.3 — Terrain Adaptation](/docs/module-2/week-9-10/terrain-adaptation) to learn how to walk on uneven ground, stairs, and obstacles.
