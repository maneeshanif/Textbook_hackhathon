---
title: "2.1.4 — Balance and Zero Moment Point (ZMP)"
sidebar_label: "2.1.4 — Balance & ZMP"
sidebar_position: 4
...
# 2.1.4 — Balance and Zero Moment Point (ZMP)

<DifficultyBadge level="intermediate" />

> **Summary**: Master the fundamental stability criterion for bipedal robots — the key to standing, walking, and recovering from disturbances.
...
- **ZMP inside support polygon** → Robot is balanced
- **ZMP on edge** → Robot is about to tip
- **ZMP outside** → Robot is falling (unrecoverable without external support)
...
1. **Double Support**: Both feet on ground → Large support polygon
2. **Single Support**: One foot on ground → Small support polygon
...
✅ **ZMP**: Point where net moment is zero — key stability criterion  
✅ **LIPM**: Simplified model relating CoM to ZMP  
✅ **Balance Control**: Adjust CoM acceleration to keep ZMP inside support  
✅ **Preview Control**: Look-ahead optimization for walking  
✅ **Capture Point**: Where to step to recover balance
...
**Next:** Continue to [Module 3 — Sensors and Perception](../../module-3/) to learn how robots sense their environment!
