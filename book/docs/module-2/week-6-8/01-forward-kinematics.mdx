---
title: "2.1.1 — Forward Kinematics"
...
- [2.1 — Kinematics & Dynamics Overview](/docs/module-2/week-6-8/) — Mathematical background
...
```mermaid
graph LR
    A[Joint Angles<br/>θ₁, θ₂, ..., θₙ] -->|Forward<br/>Kinematics| B[End-Effector Pose<br/>position + orientation]
...
This allows us to combine rotation and translation in a single 4×4 matrix.
...
print(f"Vertical range: 0 to d₃_max (typically 0.2-0.3 m)")
```
...
Vertical range: 0 to d₃_max (typically 0.2-0.3 m)
```
...
Continue to [2.1.2 — Inverse Kinematics](/docs/module-2/week-6-8/inverse-kinematics) to learn how to compute joint angles needed to reach a desired position (the reverse problem).
