...
- [1.1.2 — Humanoid Overview](/docs/module-1/week-1-2/humanoid-overview) - Humanoid robot design principles
...
Continue to [Module 2: Humanoid Robotics Fundamentals](/docs/module-2/) to dive deep into the kinematics, dynamics, and control of humanoid systems.
