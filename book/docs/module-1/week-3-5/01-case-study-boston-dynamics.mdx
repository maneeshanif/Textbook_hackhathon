...
- [1.1.2 — Humanoid Overview](../../week-1-2/02-humanoid-overview) — Robot subsystems knowledge
- [1.1.3 — Design Principles](../../week-1-2/03-design-principles) — Engineering tradeoffs
...
Continue to [1.2.2 — Case Study: Tesla Optimus](./02-case-study-tesla-optimus) to see a completely different approach: AI-first, cost-optimized, mass-production focused humanoid design.
