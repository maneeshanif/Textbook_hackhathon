...
- [1.1.3 — Design Principles](/docs/module-1/week-1-2/design-principles) — Engineering tradeoffs
- [1.2 — Historical Development](/docs/module-1/week-3-5/) — Context of humanoid robotics evolution
...
Continue to [1.2.2 — Case Study: Tesla Optimus](/docs/module-1/week-3-5/case-study-tesla-optimus) to see a completely different approach: AI-first, cost-optimized, mass-production focused humanoid design.
