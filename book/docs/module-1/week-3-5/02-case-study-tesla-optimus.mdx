...
- [1.1.3 — Design Principles and Tradeoffs](../../week-1-2/03-design-principles) — Cost optimization frameworks
- [1.2.1 — Case Study: Boston Dynamics Atlas](./01-case-study-boston-dynamics) — Alternative approach for comparison
