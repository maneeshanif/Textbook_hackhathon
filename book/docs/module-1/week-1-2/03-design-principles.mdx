...
- [1.1.1 — What is Physical AI?](./01-what-is-physical-ai) - Physical AI fundamentals
- [1.1.2 — Humanoid Overview](./02-humanoid-overview) - Robot subsystems knowledge
...
Continue to [Week 3-5: Historical Development](../week-3-5/index) to see how these design principles evolved through real humanoid robot projects over the past 50 years.
