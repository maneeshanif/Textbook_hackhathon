...
<ChapterHeader
  ...
  description="Learn the fundamentals of Physical AI, embodied intelligence, and how AI systems interact with the physical world"
  tags={['physical-ai', 'embodied-ai', 'robotics', 'fundamentals']}
/>
...
- [Week 1-2 Overview](/docs/module-1/week-1-2/) - Introduction to module structure
...
<DifficultyBadge level="beginner" /> This section introduces foundational concepts.
...
Continue to [1.1.2 — Humanoid Robotics Overview](/docs/module-1/week-1-2/humanoid-overview) to explore the specific challenges and design principles of humanoid robots.
