---
title: "3.1.4 — Sensor Fusion"
sidebar_label: "3.1.4 — Sensor Fusion"
sidebar_position: 4
...
|--------|-----------|----------|------------|
| **Averaging** | Low | Homogeneous sensors | ✅ Yes |
| **Complementary Filter** | Low | IMU fusion | ✅ Yes |
| **Kalman Filter** | Medium | Linear systems | ✅ Yes |
| **Extended Kalman (EKF)** | High | Nonlinear systems | ✅ Yes |
| **Particle Filter** | Very High | Multi-modal distributions | ⚠️ Slow |

---

## 🎯 Part 1: Kalman Filter Basics
...
## 🎯 Part 3: Complete Robot State Estimator
...
**Fusion Strategy:**
- High-rate: Encoders + IMU → Base state
- Low-rate: Vision → Drift correction
- Event-based: Force sensors → Contact detection
...
### 🎯 Exercise: Build Complete State Estimator
...
**Success Criteria**:
- ✅ Position error < 5 cm over 10 second walk
- ✅ Orientation error < 2°
- ✅ Correct contact detection (>95% accuracy)
- ✅ Real-time performance (>500 Hz)
